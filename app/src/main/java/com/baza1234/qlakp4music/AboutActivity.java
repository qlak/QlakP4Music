...
import static com.baza1234.qlakp4music.R.id.market;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent libraryIntent = new Intent(AboutActivity.this, MainActivity.class);
        ...
        play.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent playIntent = new Intent(AboutActivity.this, PlayActivity.class);
        ...
        library.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent libraryIntent = new Intent(AboutActivity.this, LibraryActivity.class);
                startActivity(libraryIntent);
            }
        });
